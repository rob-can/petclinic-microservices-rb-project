...
resource "aws_instance" "kube-master" {
    ...
    vpc_security_group_ids = [aws_security_group.petclinic-kube-master-sg.id, aws_sec
...
resource "aws_instance" "worker-1" {
    ...
    vpc_security_group_ids = [aws_security_group.petclinic-kube-worker-sg.id, aws_sec
petclinic-mutual-sg.id]
    key_name = "clarus"
    subnet_id = "subnet-c41ba589"  # select own subnet_id of us-east-1a
    availability_zone = "us-east-1a"
